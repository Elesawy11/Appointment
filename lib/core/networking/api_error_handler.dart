...
class ResponseMessage {
  ...
  // local status code
  static String CONNECT_TIMEOUT = ApiErrorsMessage.timeoutError;
  static String CANCEL = ApiErrorsMessage.defaultError;
  static String RECIEVE_TIMEOUT = ApiErrorsMessage.timeoutError;
  static String SEND_TIMEOUT = ApiErrorsMessage.timeoutError;
  static String CACHE_ERROR = ApiErrorsMessage.cacheError;
  static String NO_INTERNET_CONNECTION = ApiErrorsMessage.noInternetError;
  static String DEFAULT = ApiErrorsMessage.defaultError;
}
